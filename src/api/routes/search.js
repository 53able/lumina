...
import { SearchRequestSchema, SearchResponseSchema, } from "../../shared/schemas/index.js";
...
export const searchRoute = createRoute({
    ...
    tags: ["search"],
    summary: "セマンティック検索",
    description: "クエリをAIで拡張し、検索用Embeddingを生成します。実際の検索はクライアント側で行います。",
    request: {
        body: {
            content: {
                "application/json": {
 ...
 */
const generateStubExpandedQuery = (query) => {
