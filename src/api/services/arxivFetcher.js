 ...
 * XMLからリンクを抽出するヘルパー
 */
const extractLink = (xml, rel, type) => {
 ...
 */
export const parseArxivEntry = (entryXml) => {
 ...
 */
const buildSearchQuery = (categories) => {
    // カテゴリをOR条件で結合
 ...
 */
export const fetchArxivPapers = async (options) => {
