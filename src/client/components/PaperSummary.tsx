...
export const PaperSummary: FC<PaperSummaryProps> = ({
  ...
  const [language, setLanguage] = useState<"ja" | "en">(selectedLanguage);
  ...
  useEffect(() => {
    ...
    if (shouldAutoGenerate) {
      hasAutoGeneratedRef.current = paperId;
      // 自動生成時は説明文も含める
      onGenerate(paperId, language, "both");
    }
  }, [paperId, summary, isLoading, autoGenerate, onGenerate, language]);
  ...
  const handleGenerate = (target: GenerateTarget) => {
    onGenerate?.(paperId, language, target);
  };
